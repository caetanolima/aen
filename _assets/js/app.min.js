...
function news_mansory(){var e=jQuery("body").width(),t=jQuery(".list-news-column");e>480?t.masonry({itemSelector:".grid-item"}):t.masonry()&&t.masonry("destroy")}function inner_single_aside(){var e=jQuery("body").width(),t=jQuery(".inner-news article").height();if(e>768&&t){var i=jQuery(".inner-news aside .mais-noticias").height();jQuery(".inner-news aside").css({"min-height":t,"padding-bottom":i})}else jQuery(".inner-news aside").css({"min-height":"auto","padding-bottom":"0"})}function carousel_mobile(){var e=jQuery(window).width(),t=jQuery(".item-photos .gallery");gallery_blue=jQuery(".noticias-with-blue .gallery"),e<768?(t.addClass("owl-carousel"),gallery_list=t.owlCarousel({loop:!1,nav:!1,items:2}),gallery_blue.addClass("owl-carousel"),gallery_list_blue=gallery_blue.owlCarousel({loop:!1,nav:!1,responsive:{0:{items:1},480:{items:2}}})):(t.hasClass("owl-carousel")||gallery_blue.hasClass("owl-carousel"))&&(gallery_list.trigger("destroy.owl.carousel"),gallery_list=!1,t.removeClass("owl-carousel"),gallery_list_blue.trigger("destroy.owl.carousel"),gallery_list_blue=!1,gallery_blue.removeClass("owl-carousel"))}function header_reduced(e){var t=jQuery("body").width(),i=jQuery(this).scrollTop();t>=768&&(i<=200?jQuery("header.reduced").fadeOut():jQuery("header.reduced").fadeIn())}function btn1(){var e=jQuery(".header-main-navigation").offset().top+46;jQuery("html, body").animate({scrollTop:e},500)}function btn2(){jQuery("html, body").animate({scrollTop:jQuery(".header-main-navigation").offset().top},500)}function btn3(){jQuery("html, body").animate({scrollTop:jQuery("footer.footer-main").offset().top},1e3)}function btn4(){location.href="http://www.aen.pr.gov.br/acessibilidade.php"}function btn5(){jQuery("body").toggleClass("dark")}function btn6(){jQuery("body").toggleClass("resize-fonts")}var gallery_list=!1,gallery_list_blue=!1;jQuery(document).ready(function(e){function t(e){var t=e.item.count-1,i=Math.round(e.item.index-e.item.count/2-.5);i<0&&(i=t),i>t&&(i=0),a.find(".owl-item").removeClass("current").eq(i).addClass("current");var l=a.find(".owl-item.active").length-1,o=a.find(".owl-item.active").first().index(),n=a.find(".owl-item.active").last().index();i>n&&a.data("owl.carousel").to(i,100,!0),i<o&&a.data("owl.carousel").to(i-l,100,!0)}function i(e){if(r){var t=e.item.index;n.data("owl.carousel").to(t,100,!0)}}new mlPushMenu(document.getElementById("mp-menu"),document.getElementById("trigger"),{type:"cover"}),e(document).keypress(function(t){e(t.target).is("input, textarea")||(49==t.which?btn1():50==t.which?btn2():51==t.which?btn3():52==t.which?btn4():53==t.which?btn5():54==t.which&&btn6())}),e(".btn1").click(function(){return btn1(),!1}),e(".btn2").click(function(){return btn2(),!1}),e(".btn3").click(function(){return btn3(),!1}),e(".btn4").click(function(){return btn4(),!1}),e(".btn5").click(function(){return btn5(),!1}),e(".btn6").click(function(){return btn6(),!1});var l=e(".owl-carousel-agenda");l.owlCarousel({loop:!0,autoWidth:!0,items:1,margin:8,onInitialized:function(t){var i=0;l.find("dd").each(function(t,l){i<e(this).height()&&(i=e(this).height())}),l.find("dd").height(i)}}),e(".owl-carousel-agenda-next").on("click",function(e){e.preventDefault(),l.trigger("next.owl.carousel")}),e(".owl-carousel-videos-list").owlCarousel({items:5,loop:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}),e(".owl-carousel-aviso-pauta").owlCarousel({items:1,dots:!0,slideSpeed:2e3,autoplay:!0,animateIn:"fadeIn",animateOut:"fadeOut"}),e(".owl-carousel-videos-highlight").owlCarousel({loop:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{0:{items:1},480:{items:2},768:{items:3}}}),e(window).bind("scroll",header_reduced),e(".to-top").click(function(){return e("body,html").animate({scrollTop:0},800),!1}),news_mansory(),inner_single_aside(),carousel_mobile(),window.onresize=function(){news_mansory(),inner_single_aside(),carousel_mobile()},e('[data-toggle="tooltip"]').tooltip(),e(".video-show").find(".show-more").click(function(){return e(this).hide(),e(this).prev("div.description").addClass("showed"),!1});var o=e(".editorias li");e(o).click(function(){e(this).hasClass("selected")?(e(this).children("input").prop("checked",!1),e(this).removeClass("selected")):(e(this).children("input").prop("checked",!0),e(this).addClass("selected"))});var n=e(".gallery-slide"),a=e(".gallery-thumbs"),s=6,r=!0;n.owlCarousel({items:1,slideSpeed:2e3,nav:!0,autoplay:!0,dots:!0,loop:!0,responsiveRefreshRate:200,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}).on("changed.owl.carousel",t),a.on("initialized.owl.carousel",function(){a.find(".owl-item").eq(0).addClass("current")}).owlCarousel({items:s,dots:!0,nav:!0,smartSpeed:200,slideSpeed:500,slideBy:s,responsiveRefreshRate:100}).on("changed.owl.carousel",i),a.on("click",".owl-item",function(t){t.preventDefault();var i=e(this).index();n.data("owl.carousel").to(i,300,!0)})});